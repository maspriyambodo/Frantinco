...
<div class="card card-custom" data-card="true">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Report/Category/Product/index/'); ?>" class="btn btn-default"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
...
<script>
    ...
    function dt_tabel(tokentxt) {
        $('table').dataTable({
            ...
            "ajax": {
                "url": "Report/Category/Product_report/dt_table?token=" + tokentxt,
                dataSrc: ''
            },
            columns: [
                {
