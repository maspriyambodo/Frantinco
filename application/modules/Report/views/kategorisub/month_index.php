...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Report/Categorysub/Dashboard/index/'); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> back</a>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#table').dataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('Report/Categorysub/Bulan/lists/'); ?>",
                "type": "GET",
                "data": {"token": tokentxt}
            },
            columnDefs: [
