        ...
        if (empty($tahun)) {
            ...
            foreach ($this->model->dt_table($tahun) as $value) {
                ...
                $data[] = [
                    ...
                    'JANUARI' => ($value->JANUARI == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=01' . '&c=' . $value->id . '&d=' . $value->JANUARI))) . '">' . number_format($value->JANUARI) . '</a>',
                    'FEBRUARI' => ($value->FEBRUARI == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=02' . '&c=' . $value->id . '&d=' . $value->FEBRUARI))) . '">' . number_format($value->FEBRUARI) . '</a>',
                    'MARET' => ($value->MARET == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=03' . '&c=' . $value->id . '&d=' . $value->MARET))) . '">' . number_format($value->MARET) . '</a>',
                    'APRIL' => ($value->APRIL == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=04' . '&c=' . $value->id . '&d=' . $value->APRIL))) . '">' . number_format($value->APRIL) . '</a>',
                    'MEI' => ($value->MEI == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=05' . '&c=' . $value->id . '&d=' . $value->MEI))) . '">' . number_format($value->MEI) . '</a>',
                    'JUNI' => ($value->JUNI == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=06' . '&c=' . $value->id . '&d=' . $value->JUNI))) . '">' . number_format($value->JUNI) . '</a>',
                    'JULI' => ($value->JULI == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=07' . '&c=' . $value->id . '&d=' . $value->JULI))) . '">' . number_format($value->JULI) . '</a>',
                    'AGUSTUS' => ($value->AGUSTUS == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=08' . '&c=' . $value->id . '&d=' . $value->AGUSTUS))) . '">' . number_format($value->AGUSTUS) . '</a>',
                    ...
                    'OKTOBER' => ($value->OKTOBER == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=10' . '&c=' . $value->id . '&d=' . $value->OKTOBER))) . '">' . number_format($value->OKTOBER) . '</a>',
                    'NOVEMBER' => ($value->NOVEMBER == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=11' . '&c=' . $value->id . '&d=' . $value->NOVEMBER))) . '">' . number_format($value->NOVEMBER) . '</a>',
                    'DESEMBER' => ($value->DESEMBER == null) ? 0 : '<a href="' . base_url('Laporan1%23?token=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=12' . '&c=' . $value->id . '&d=' . $value->DESEMBER))) . '">' . number_format($value->DESEMBER) . '</a>'
                ];
            }
        }
        return ToJson($data);
